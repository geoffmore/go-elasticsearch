...
[![GoDoc](https://godoc.org/github.com/geoffmore/go-elasticsearch?status.svg)](http://godoc.org/github.com/geoffmore/go-elasticsearch)
[![Travis-CI](https://travis-ci.org/geoffmore/go-elasticsearch.svg?branch=master)](https://travis-ci.org/geoffmore/go-elasticsearch)
[![Go Report Card](https://goreportcard.com/badge/github.com/geoffmore/go-elasticsearch)](https://goreportcard.com/report/github.com/geoffmore/go-elasticsearch)
[![codecov.io](https://codecov.io/github/geoffmore/go-elasticsearch/coverage.svg?branch=master)](https://codecov.io/gh/geoffmore/go-elasticsearch?branch=master)

## Compatibility

The client major versions correspond to the compatible Elasticsearch major versions: to connect to Elasticsearch `7.x`, use a [`7.x`](https://github.com/geoffmore/go-elasticsearch/tree/7.x) version of the client, to connect to Elasticsearch `6.x`, use a [`6.x`](https://github.com/geoffmore/go-elasticsearch/tree/6.x) version of the client.

When using Go modules, include the version in the import path, and specify either an explicit version or a branch:

    require github.com/geoffmore/go-elasticsearch/v7 7.x
    require github.com/geoffmore/go-elasticsearch/v7 7.0.0

It's possible to use multiple versions of the client in a single project:

    // go.mod
    github.com/geoffmore/go-elasticsearch/v6 6.x
    github.com/geoffmore/go-elasticsearch/v7 7.x

    // main.go
    import (
      elasticsearch6 "github.com/geoffmore/go-elasticsearch/v6"
      elasticsearch7 "github.com/geoffmore/go-elasticsearch/v7"
    )
    // ...
...
Add the package to your `go.mod` file:
    ...
    require github.com/geoffmore/go-elasticsearch/v8 master

Or, clone the repository:

    git clone --branch master https://github.com/geoffmore/go-elasticsearch.git $GOPATH/src/github.com/geoffmore/go-elasticsearch
...
import (
  ...
  "github.com/geoffmore/go-elasticsearch/v8"
  "github.com/geoffmore/go-elasticsearch/v8/esapi"
)
...
[package documentation](https://godoc.org/github.com/geoffmore/go-elasticsearch/esapi).
